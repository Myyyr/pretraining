#!/bin/bash
#SBATCH --job-name=meglamswintiny     # job name
...
#SBATCH --output=logs/meglamswintiny%j.out # output file name
#SBATCH --error=logs/meglamswintiny%j.err  # error file name
...
CONFIG="configs/glam_swin_tiny_me_patch4_window7_224.yaml"
# CONFIG="configs/glam_segformer_patch4_window7_224.yaml"


# swin
srun /gpfslocalsup/pub/idrtools/bind_gpu.sh python -u  main.py --cfg $CONFIG --data-path $DATA --batch-size 128 --local_rank 0 $1 $2 --opts TRAIN.EPOCHS 600
