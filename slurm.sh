#!/bin/bash
#SBATCH --job-name=glamsf     # job name
...
#SBATCH --output=logs/glamsf%j.out # output file name
#SBATCH --error=logs/glamsf%j.err  # error file name
...
# swin
srun /gpfslocalsup/pub/idrtools/bind_gpu.sh python -u  main.py --cfg $CONFIG --data-path $DATA --batch-size 128 --local_rank 0 --accumulation-steps 64 --use-checkpoint
